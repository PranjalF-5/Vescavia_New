...
const videoReels = [
  { title: "Brand Manifesto", duration: "01:15", image: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?q=80&w=1000&auto=format&fit=crop", progress: 70 },
  { title: "Neon Nights Campaign", duration: "00:45", image: "https://images.unsplash.com/photo-1533174072545-e8d4aa97edf9?q=80&w=1000&auto=format&fit=crop", progress: 40 },
  { title: "Tech Launch 2024", duration: "02:30", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1000&auto=format&fit=crop", progress: 90 },
  { title: "Urban Rhythms", duration: "01:00", image: "https://images.unsplash.com/photo-1514525253440-b393452e3726?q=80&w=1000&auto=format&fit=crop", progress: 20 },
  { title: "Abstract Motion", duration: "00:30", image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=1000&auto=format&fit=crop", progress: 55 },
];
